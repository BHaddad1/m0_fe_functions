...
function printGreeting(){
  console.log("Hello fellow Mod 0 student!");
}
printGreeting();
printGreeting();
printGreeting();
...
function printPace(pace1){
  console.log(`On my run today my pace was ${pace1}.`);
}
printPace("9:18");


// 3: Write a function that has 3 parameters: a string and two numbers.
//The String will be the name of a company, and the numbers will represent the
...
function printPayRange(name, lowest, highest){
  var range = highest - lowest
console.log(`The compensation for this job at ${name} has a range of ${range}`);
}
printPayRange("Google", 110000, 150000);
